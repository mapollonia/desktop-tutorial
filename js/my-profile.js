...
function saveData(){
    ...
    profile.lastName = document.getElementById("userLastName").value;
    profile.age = document.getElementById("userAge").value;
    profile.mail = document.getElementById("userMail").value;
...
document.addEventListener("DOMContentLoaded", function (e) {
    let form = document.getElementById("profile-info");
